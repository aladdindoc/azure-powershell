...
This example updates an AlertRuleAction replacing an existing Action with new properties. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzSentinelAlertRuleAction -ActionId 'MyActionId' -AlertRuleId 'MyAlertRuleId' -LogicAppResourceId <String> -ResourceGroupName myresourcegroup -TriggerUri <String> -WorkspaceName 'MyWorkspaceName'
```
