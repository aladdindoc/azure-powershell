...
Compiles a DSC configuration in Automation. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Start-AzAutomationDscCompilationJob -AutomationAccountName 'AutomationAccount01' -ConfigurationData <IDictionary> -ConfigurationName 'Config01' -ResourceGroupName 'ResourceGroup01'
```
