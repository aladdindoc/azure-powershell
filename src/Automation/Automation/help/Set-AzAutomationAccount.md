...
Modifies an Automation account. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzAutomationAccount -AssignSystemIdentity -KeyName <String> -KeyVaultEncryption -KeyVaultUri <String> -KeyVersion <String> -Name 'AutomationAccount01' -ResourceGroupName 'ResourceGroup01'
```
