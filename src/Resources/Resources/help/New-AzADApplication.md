...
Creates a new azure active directory application. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzADApplication -DisplayName 'NewApplication' -HomePage 'https://www.microsoft.com' -IdentifierUri 'https://NewApplication' -ReplyUrls <String[]>
```
