...
Creates an App Service Environment including the recommended Route Table and Network Security Group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzAppServiceEnvironment -Kind ASEv2 -LoadBalancerMode Internal -Location WestEurope -Name MyAseV2 -ResourceGroupName MyResourceGroup -SubnetId <String>
```
