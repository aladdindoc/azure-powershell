...
Import an SSL certificate to a web app from Key Vault. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Import-AzWebAppKeyVaultCertificate -CertName 'ContosoCertname' -KeyVaultName 'ContosoKeyVault' -ResourceGroupName 'Default-Web-WestUS' -WebAppName 'ContosoSite'
```
