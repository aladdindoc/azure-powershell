...
Opens a remote PowerShell session into the windows container specified in a given site or slot and given resource group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Enter-AzWebAppContainerPSSession -Name 'ContosoASP' -ResourceGroupName 'Default-Web-WestUS' -SlotName <String>
```
