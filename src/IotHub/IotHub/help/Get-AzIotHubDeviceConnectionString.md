...
Get the secondary connection string of an IoT device. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzIotHubDeviceConnectionString -DeviceId 'myDevice1' -IotHubName 'myiothub' -KeyType primary -ResourceGroupName 'myresourcegroup'
```
