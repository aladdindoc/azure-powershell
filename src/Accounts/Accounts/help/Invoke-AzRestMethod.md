...
Construct and perform HTTP request to Azure resource management endpoint only. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Invoke-AzRestMethod -Method GET -Path '/subscriptions/{subscription}/resourcegroups/{resourcegroup}/providers/microsoft.operationalinsights/workspaces/{workspace}?api-version={API}' -Payload <String>
```
