...
Creates a WAF configuration for an application gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApplicationGatewayWebApplicationFirewallConfiguration -Enabled $true -FirewallMode Detection -RequestBodyCheck $false -RuleSetType OWASP -RuleSetVersion 3.0
```
