...
```powershell
Add-AzLoadBalancerInboundNatRuleConfig -BackendPort 3350 -EnableFloatingIP -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPort 3350 -Name 'NewNatRule' -Protocol 'TCP' -LoadBalancer <PSLoadBalancer>
```
