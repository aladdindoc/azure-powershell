...
Creates a back-end address pool for an application gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApplicationGatewayBackendAddressPool -BackendIPAddresses '192.168.1.1' -Name 'ContosoAddressPool'
```
