...
Modifies an HTTP listener for an application gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzApplicationGatewayHttpListener -ApplicationGateway <PSApplicationGateway> -FrontendIPConfiguration <PSApplicationGatewayFrontendIPConfiguration> -FrontendPort <PSApplicationGatewayFrontendPort> -HostName 'contoso.com' -Name 'Listener01' -Protocol https -RequireServerNameIndication $true
```
