...
<!-- Aladdin Generated Example -->
```powershell
New-AzApplicationGatewayBackendHttpSetting -CookieBasedAffinity Enabled -HostName 'contoso.com' -Name 'Setting01' -Port 80 -Probe <PSApplicationGatewayProbe> -Protocol https -RequestTimeout <Int32>
```
