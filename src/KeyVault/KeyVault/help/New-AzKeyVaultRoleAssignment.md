...
Assigns the specified RBAC role to the specified principal, at the specified scope. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzKeyVaultRoleAssignment -HsmName myHsm -ObjectId 00000000-0000-0000-0000-00000000000000000 -RoleDefinitionName 'Managed HSM Policy Administrator'
```
