...
```powershell
Set-AzKeyVaultCertificatePolicy -Name 'TestCert01' -RenewAtPercentageLifetime <Int32> -ValidityInMonths 6 -VaultName 'ContosoKV01' -InputObject <PSKeyVaultCertificatePolicy>
```
