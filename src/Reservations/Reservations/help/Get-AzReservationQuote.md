...
```powershell
Get-AzReservationQuote -AppliedScope '/subscriptions/00000000-0000-0000-0000-000000000000fff' -AppliedScopeType 'Shared' -BillingPlan <String> -BillingScopeId '/subscriptions/00000000-0000-0000-0000-00000000000000000' -DisplayName <String> -InstanceFlexibility 'Off' -Location 'centralus' -Quantity 2 -ReservedResourceType 'VirtualMachines' -Sku <String> -Term 'P1Y'
```
