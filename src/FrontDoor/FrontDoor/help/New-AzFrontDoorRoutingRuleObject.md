...
```powershell
New-AzFrontDoorRoutingRuleObject -BackendPoolName 'backendPool1' -EnabledState Enabled -ForwardingProtocol HttpsOnly -FrontDoorName <String> -FrontendEndpointName 'frontendEndpoint1' -Name <String> -ResourceGroupName <String>
```
