...
Updates a workspace. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzOperationalInsightsWorkspace -Name 'MyWorkspace' -ResourceGroupName 'ContosoResourceGroup' -RetentionInDays <Int32> -Sku free
```
