...
Creates an ASR NIC IP config that contains the failover and test failover configuration details for each IP Config (Primary and Secondary) of the NIC. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzRecoveryServicesAsrVMNicIPConfig -IpConfigName 'ipconfig1' -IsSelectedForFailover -RecoveryStaticIPAddress '10.1.40.10' -RecoverySubnetName 'default' -TfoStaticIPAddress '10.3.4.32' -TfoSubnetName 'default'
```
