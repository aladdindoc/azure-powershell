...
```powershell
Set-AzSynapseIntegrationRuntime -DataFlowComputeType <String> -DataFlowCoreCount <Int32> -DataFlowTimeToLive <Int32> -Location westus -Name 'test-selfhost-ir' -Type Managed -WorkspaceName ContosoWorkspace
```
