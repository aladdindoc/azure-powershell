...
```powershell
Start-AzSqlInstanceDatabaseLogReplay -AsJob -Collation <String> -InstanceName 'ManagedInstance01' -Name 'ManagedDatabaseName' -ResourceGroupName 'ResourceGroup01' -StorageContainerSasToken <String> -StorageContainerUri <String>
```
