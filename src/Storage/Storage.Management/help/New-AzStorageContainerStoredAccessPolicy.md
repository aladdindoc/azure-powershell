...
Creates a stored access policy for an Azure storage container. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzStorageContainerStoredAccessPolicy -Container 'MyContainer' -Context <IStorageContext> -ExpiryTime <DateTime> -Permission rwd -Policy 'Policy01'
```
