...
Gets details of all the API Revisions of an API. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzApiManagementApiRevision -ApiId '5adf6fbf0faadf3ad8558065' -ApiRevision 6 -Context <PsApiManagementContext>
```
