...
<!-- Aladdin Generated Example -->
```powershell
Set-AzApiManagementBackend -BackendId 123 -Context <PsApiManagementContext> -Protocol https -SkipCertificateChainValidation $true -Url 'https://contoso.com/awesomeapi'
```
