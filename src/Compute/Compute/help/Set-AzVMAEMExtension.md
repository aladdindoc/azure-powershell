...
Enables support for monitoring for SAP systems. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzVMAEMExtension -InstallNewExtension -ResourceGroupName 'ResourceGroup11' -VMName 'contoso-server'
```
