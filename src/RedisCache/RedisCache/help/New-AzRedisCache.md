...
Creates a Redis Cache. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzRedisCache -EnableNonSslPort $false -Location 'North Central US' -Name 'MyCache' -ResourceGroupName 'MyGroup' -Size 250MB -Sku Basic -Tag <Hashtable>
```
