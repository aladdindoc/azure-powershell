...
```powershell
Update-AzCosmosDBSqlContainer -AccountName accountName -DatabaseName myDatabaseName -Name accountName -PartitionKeyKind Hash -PartitionKeyPath /a -ResourceGroupName myresourcegroup -Throughput 600
```
