...
```powershell
Update-AzCosmosDBSqlContainer -AccountName accountName -DatabaseName myDatabaseName -Name accountName -ResourceGroupName myresourcegroup -TtlInSeconds <Int32>
```
