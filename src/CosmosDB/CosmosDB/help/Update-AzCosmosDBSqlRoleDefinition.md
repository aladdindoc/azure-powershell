...
Updates an existing CosmosDB Sql Role Definition. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBSqlRoleDefinition -AccountName accountName -AssignableScope <List`1> -DataAction 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/items/create' -Id roleAssignmentId -ResourceGroupName myresourcegroup -RoleName <String> -Type 'ReadOnlyKeys'
```
