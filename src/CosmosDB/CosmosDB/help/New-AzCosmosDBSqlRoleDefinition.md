...
Creates a new CosmosDB Sql Role Definition. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBSqlRoleDefinition -AccountName accountName -AssignableScope <List`1> -DataAction 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/items/create' -ResourceGroupName myresourcegroup -RoleName <String> -Type 'ReadOnlyKeys'
```
