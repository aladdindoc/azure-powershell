...
Creates a new CosmosDB Sql Container. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBSqlContainer -AccountName myAccountName -DatabaseName myDatabaseName -Name myContainerName -PartitionKeyKind Hash -PartitionKeyPath /a/b/c -ResourceGroupName myRgName -Throughput 700
```
