...
Create a new CosmosDB Account. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBAccount -ApiKind <String> -EnableVirtualNetwork -Location 'East US' -Name databaseAccountName -ResourceGroupName resourceGroupName -VirtualNetworkRule <String[]>
```
